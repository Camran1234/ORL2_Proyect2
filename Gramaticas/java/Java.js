...
break;
case 31: case 58: case 59: case 66: case 70: case 71: case 72: case 73: case 74: case 75: case 90: case 94: case 95: case 149: case 159: case 173: case 174: case 175: case 176: case 177: case 178: case 204: case 205: case 206: case 224: case 234:
this.$=$$[$0];
break;
case 32:
...
case 34:
            ...
            this.$ = instruccionesApi.nuevaClase(TIPO_VISIBILIDAD.PUBLIC, $$[$0-3], $$[$0-1],reversaArreglo($$[$0]), null, lenguaje, linea(this._$.first_line), columna(this._$.first_column));
...
case 38:
            ...
            for(var index=0; index<$$[$0-1].length; index++){
                if($$[$0-1][index].rol == TIPO_INSTRUCCION.FUNCION ||
                $$[$0-1][index].rol == TIPO_INSTRUCCION.DECLARACION){
                    $$[$0-1][index].visibilidad = $$[$0-2];
                }
                $$[$0].push($$[$0-1][index]);
            }
            this.$=$$[$0];
...
case 50:
            ...
            var funcion = instruccionesApi.nuevaFuncion(null, $$[$0-4],null, reversaArreglo($$[$0]), $$[$0-2], lenguaje, linea(this._$.first_line), columna(this._$.first_column));
            var arreglo = [];
...
case 65:
            ...
            if($$[$0][0].rol == TIPO_INSTRUCCION.FUNCION){
                arreglo = $$[$0][0];
            }else if($$[$0][0].rol == TIPO_INSTRUCCION.DECLARACION ||
            $$[$0][0].rol == TIPO_INSTRUCCION.ASIGNACION_O){
                var aux = $$[$0];
...
break;
case 68:
addSyntaxError("Se esperaba una declaracion", $$[$0-1], linea(this._$.first_line), columna(this._$.first_column));
break;
case 76: case 78: case 80: case 144: case 179: case 181: case 183: case 225: case 227:
this.$=$$[$0-1];
break;
