    ...
    function addSyntaxErrorStmt(stmt, line, column){
        try{
            ...
            if(stmtRol == TIPO_INSTRUCCION.VARIABLE){
                var errorSintactico = new ErrorSintactico("Se esperaba que estuviera dentro de una declaracion contenedora",stmt.id, stmt.linea, stmt.columna);
                erroresSintacticos.push(errorSintactico);
            }else if (stmtRol == TIPO_INSTRUCCION.FUNCION){
                var errorSintactico = new ErrorSintactico("Se esperaba que estuviera dentro de una declaracion contenedora",stmt.id, stmt.linea, stmt.columna);
                erroresSintacticos.push(errorSintactico);
            }else{
                var errorSintactico = new ErrorSintactico("Se esperaba que estuviera dentro de una declaracion contenedora",stmt.rol, stmt.linea, stmt.columna);
                erroresSintacticos.push(errorSintactico);
            }
